...
| <img src="../.gitbook/assets/火箭发射.png" alt="" data-size="original"> | <img src="../.gitbook/assets/变轨展开.png" alt="" data-size="original"> | <img src="../.gitbook/assets/环绕同步.png" alt="" data-size="original">                             | <img src="../.gitbook/assets/空间站组装对接.png" alt="" data-size="original">                                                                               | ![](<../.gitbook/assets/image (2) (1).png>)       |
| <ul><li>定投</li></ul>                                                | <ul><li>单币网格</li><li>单币流动性挖矿</li></ul>                              | <p></p><ul><li>双币网格</li><li>双币流动性挖矿<br></li></ul>                                               | <ul><li>多币动态平衡（市值占比分配）</li></ul>                                                                                                                     | <ul><li>做空！</li><li>割韭菜！</li></ul>                |
| <ul><li>USDT<br>->BTC</li><li>USDT<br>->ETH</li></ul>               | <ul><li>BTC/USDT</li><li>ETH/USDT</li></ul>                         | <ul><li>ETH/BTC</li><li>MATIC/BNB</li><li>DOGE/SHIB</li></ul><ul><li>PAXG/USDT(黄金/美元)</li></ul> | <ul><li>BTC</li><li>ETH</li><li>BNB<br></li><li>ADA</li><li>MATIC</li><li>DOGE</li><li>DOT</li><li>SHIB</li></ul><ul><li>AVAX</li><li>ATOM</li></ul> | <ul><li>BTC杠杆代币（做空）</li><li>ETH杠杆代币（做空）</li></ul> |
| <ul><li>币安 🆓</li><li>KuCoin 🆓</li></ul>                           | <ul><li>币安 🆓</li><li>KuCoin 🆓</li></ul>                           | <ul><li>币安🆓</li><li>KuCoin 🆓</li></ul>                                                        | <ul><li>币安 🆓</li><li>KuCoin 🆓</li></ul>                                                                                                            | <ul><li>币安 🆓</li></ul>                           |
...
{% content-ref url="../bfm-ds-bi-fang-meng-shu-ju-zhi-chi/shu-ju-yuan/lian-shang-shu-ju-fen-xi.md" %}
[lian-shang-shu-ju-fen-xi.md](../bfm-ds-bi-fang-meng-shu-ju-zhi-chi/shu-ju-yuan/lian-shang-shu-ju-fen-xi.md)
{% endcontent-ref %}

3. **减半，顶部，底部时间预测**

{% content-ref url="../bfm-ds-bi-fang-meng-shu-ju-zhi-chi/zi-chan-pei-zhi/shi-jian-xiao-zhun-yan-jiu.md" %}
[shi-jian-xiao-zhun-yan-jiu.md](../bfm-ds-bi-fang-meng-shu-ju-zhi-chi/zi-chan-pei-zhi/shi-jian-xiao-zhun-yan-jiu.md)
{% endcontent-ref %}
...
2，游戏内分阵营和克制，机制极其复杂，且频繁改政策和规则。过分强调比拼，排名，收益。&#x20;
