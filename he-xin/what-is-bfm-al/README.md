...
{% embed url="https://en.wikipedia.org/wiki/Bellman%E2%80%93Ford:algorithm" %}

我们利用 BFM 算法进行交叉套利路径的优化搜索。

{% embed url="https://en.wikipedia.org/wiki/Triangular:arbitrage" %}
...
![](<../../.gitbook/assets/ping-mu-kuai-zhao-20200325-xia-wu-5.59.12 (1).png>)

{% embed url="http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.86.1981&rep=rep1&type=pdf" %}

![](<../../.gitbook/assets/ping-mu-kuai-zhao-20210127-xia-wu-10.54.01 (1).png>)
...
{% content-ref url="../ruan-jian-bfm-on-python/" %}
[ruan-jian-bfm-on-python](../ruan-jian-bfm-on-python/)
{% endcontent-ref %}
