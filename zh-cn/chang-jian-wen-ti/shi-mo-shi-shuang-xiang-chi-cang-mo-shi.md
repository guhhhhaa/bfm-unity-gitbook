...
[Skip to content](https://www.antrade.io/guide/docs/cn/hedge-mode/#content)[AntBot | Crypto Trading Bot](https://www.antrade.io/guide/docs/cn/)[首页](https://www.antrade.io/guide/docs/cn/)[免费使用AntBot](https://antrade.io/)
...
双向持仓模式是一种期货交易方式，与单向持仓模式相对应。单向持仓模式指的是在同一期货资产下，不能同时持有多头和空头仓位，需要选择其中一种仓位进行持有。而双向持仓模式则允许在同一期货资产下同时持有多头和空头仓位，并且可以独立加减仓，而且多头和空头仓位之间互不干扰。

双向持仓模式在期货交易中被广泛采用，因为它可以更好地满足交易者的不同需求和交易策略，同时也能够降低交易的风险。
