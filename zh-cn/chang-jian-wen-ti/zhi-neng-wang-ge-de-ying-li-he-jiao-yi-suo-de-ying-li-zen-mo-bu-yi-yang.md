...
[Skip to content](https://www.antrade.io/guide/docs/cn/the-profit-difference-in-ai-grid-and-exchange/#content)[AntBot | Crypto Trading Bot](https://www.antrade.io/guide/docs/cn/)[首页](https://www.antrade.io/guide/docs/cn/)[免费使用AntBot](https://antrade.io/)
...
小蚁期货智能网格策略的盈利和交易所的盈利不一样，是因为它们的盈亏结算方式不同。在小蚁期货智能网格策略中，每个网格的持仓均价是独立进行交易和盈亏结算的，而在交易所中，整个仓位的持仓均价是作为一个整体进行盈亏结算的。这种差异导致了两者的盈亏显示不一致，但这是一种正常现象。
