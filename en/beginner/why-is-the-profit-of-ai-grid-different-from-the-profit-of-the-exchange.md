...
[Skip to content](https://www.antrade.io/guide/docs/en/the-profit-difference-in-ai-grid-and-exchange/#content)[AntBot | Crypto Trading Bot](https://www.antrade.io/guide/docs/en/)[Free AntBot](https://antrade.io/)
...
Because the AntBot futures AI Grid strategy trades and settles profit and loss based on the average price of each grid position, the exchange conducts profit and loss settlement based on the average price of the entire position.\
It is a normal phenomenon that the profit and loss displays on both sides are inconsistent.

[#AI Grid](https://www.antrade.io/guide/docs/en/tag/ai-grid/)[#AntBot](https://www.antrade.io/guide/docs/en/tag/antbot/)[#exchange](https://www.antrade.io/guide/docs/en/tag/exchange/)[#Profit](https://www.antrade.io/guide/docs/en/tag/profit/)@AntBot free trading bot\
