...
[Skip to content](https://www.antrade.io/guide/docs/en/one-crypto-run-multiple-bots/#content)[AntBot | Crypto Trading Bot](https://www.antrade.io/guide/docs/en/)[Free AntBot](https://antrade.io/)
...
Spot allows the same crypto to start multiple robots, but futures does not allow running two robots in the same direction of the same crypto at the same time. You can run a long robot and a short robot in futures.

[#Multiple Bots](https://www.antrade.io/guide/docs/en/tag/multiple-bots/)[#One Crypto](https://www.antrade.io/guide/docs/en/tag/one-crypto/)@AntBot free trading bot\
